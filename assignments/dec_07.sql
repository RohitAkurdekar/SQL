...
select count(*) cnt,MEMBERSHIP_STATUS,lower(CITY)
from LMS_MEMBERS
group by MEMBERSHIP_STATUS, lower(CITY);
...
having EMAIL like '%gmail%' or EMAIL like '%yahoo%'


select 
substr(EMAIL,(-9),-4) from LMS_SUPPLIERS_DETAILS;

select 
substr(EMAIL,(length(EMAIL)-8),5) from LMS_SUPPLIERS_DETAILS;

select 
substr(EMAIL,-9,5 )from LMS_SUPPLIERS_DETAILS;
...
select substr(EMAIL,(length(EMAIL)-8),5) category, count(*) count_against_category 
from LMS_SUPPLIERS_DETAILS
where EMAIL like '%gmail%' or EMAIL like '%yahoo%'
group by substr(EMAIL,(length(EMAIL)-8),5);
...
select * from LMS_MEMBERS order by DATE_REGISTER asc;

select * from LMS_MEMBERS order by MEMBER_NAME asc;

select * from LMS_MEMBERS order by MEMBER_NAME desc;

select * from LMS_MEMBERS order by MEMBERSHIP_STATUS asc;


select * from LMS_FINE_DETAILS;

select mem.MEMBER_NAME,sum(fd.FINE_AMOUNT)fine_amnt
from LMS_MEMBERS mem full join LMS_BOOK_ISSUE bi on(mem.MEMBER_ID=bi.MEMBER_ID)
full join LMS_FINE_DETAILS fd on (fd.FINE_RANGE=bi.FINE_RANGE) 
group by mem.MEMBER_NAME
order by fine_amnt desc nulls last;
...
insert into table2(col1,col2) values (1,10);
insert into table2(col1,col2) values (1,20);
insert into table2(col1,col2) values (1,30);
insert into table2(col1,col2) values (null,10);
insert into table2(col1,col2) values (null,30);
insert into table2(col1,col2) values (null,20);
insert into table2(col1,col2) values (3,30);
insert into table2(col1,col2) values (3,20);
insert into table2(col1,col2) values (3,10);

select * from table2;

select * from table2 order by col1,col2;
select * from table2 order by col1 asc,col2 asc ;
select * from table2 order by col1 asc nulls last , col2 nulls last;
